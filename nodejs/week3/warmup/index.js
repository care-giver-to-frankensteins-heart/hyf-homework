...
app.get("/calculator/add", (req, res) => {
    ...
    if (first && second) {
        if ((Number(first)) && (Number(second))) {
            ...
            if(second.every(function(element) {return typeof Number(element) === 'number';})) {
    ...
    else res.send(`You should enter two parameters for example /calculator/add?first=5&second=2`);
});
...
app.get("/calculator/subtract", (req, res) => {
    ...
    else res.send(`You should enter two parameters for example /calculator/subtract?first=5&second=2`);
});
...
app.get("/calculator/multiply", (req, res) => {
    ...
    else res.send(`You should enter two parameters for example /calculator/multiply?first=5&second=2`);
});
...
app.get("/calculator/divide", (req, res) => {
    ...
    else res.send(`You should enter two parameters for example /calculator/divide?first=5&second=2`);
});
